...
enum
{
    ...
    CPU_FEATURE_X86_AVX        = 1u << 12,
    CPU_FEATURE_X86_AVX2       = 1u << 13,
    CPU_FEATURE_X86_FMA        = 1u << 14,

    CPU_FEATURE_X86_F16C       = 1u << 15,

    CPU_FEATURE_X86_BMI1       = 1u << 16,
    CPU_FEATURE_X86_BMI2       = 1u << 17,

    CPU_FEATURE_X86_POPCNT     = 1u << 18,

    CPU_FEATURE_X86_AVX512F    = 1u << 19,
    CPU_FEATURE_X86_AVX512BW   = 1u << 20,
    CPU_FEATURE_X86_AVX512VL   = 1u << 21,
    CPU_FEATURE_X86_AVX512DQ   = 1u << 22,
};
