...
typedef enum {
    ...
    settings_pixel_width,
    settings_pixel_height,
    settings_display_type,
    settings_display_rotate,
    settings_depth_buffer,
    __numeric_settings_end__,
    // Other settings
    settings_display_size
...
static inline u8 display_is_running()
{
