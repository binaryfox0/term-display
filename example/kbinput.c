...
void key_callback(int key, int mods, key_state state) {
 ...
 if (IN_RANGE(key, term_key_astrophe, term_key_grave_accent)) {
  ...
  switch (key) {
   case term_key_space:  key_name = "Space"; break;
   case term_key_backspace: key_name = "Back"; break;
   case term_key_escape: key_name = "Esc"; break;
   case term_key_tab: key_name = "Tab"; break;
   case term_key_enter: key_name = "Enter"; break;
   case term_key_home: key_name = "Home"; break;
   case term_key_insert: key_name = "Ins"; break;
   case term_key_delete: key_name = "Del"; break;
   case term_key_end: key_name = "End"; break;
   case term_key_page_up: key_name = "PgUp"; break;
   case term_key_page_down: key_name = "PgDn"; break;
   case term_key_up: key_name = "Up"; break;
   case term_key_left: key_name = "Left"; break;
   case term_key_down: key_name = "Down"; break;
   case term_key_right: key_name = "Right"; break;
  }
...
int main() {
 ...
 if (display_init() || start_logging("statics.txt")) return 1;
